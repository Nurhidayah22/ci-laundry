    ...
    <div class="content">
        ...
        <div class="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="<?= base_url('Pelanggan/aksi_ubah') ?>" method="post">
                            <div class="card m-b-100">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="hidden" value="<?= $data_pelanggan[0]->pelangganid ?>" name="id">
                                            <input class="form-control" type="text" id="example-text-input" name="pelanggannama" placeholder="Masukkan nama" value="<?= $data_pelanggan[0]->pelanggannama ?>" required autofocus />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="example-text-input" name="pelangganalamat" cols="20" rows="5" placeholder="Masukkan alamat" required><?= $data_pelanggan[0]->pelangganalamat ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" id="example-text-input" name="pelanggantelp" placeholder="Masukkan No.Telp" value="<?= $data_pelanggan[0]->pelanggantelp ?>" required />
                                        </div>
                                    </div>
