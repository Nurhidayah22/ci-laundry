                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <h4 class="mt-0 header-title">
                                        ...
                                        <a href="<?= base_url('Laundry/LaundryLunas') ?>" class="btn btn-success">Status Lunas</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($data->status_pengambilan == 0) { ?>
                                                            <a href="<?= base_url('Laundry/aksi_ambil/' . $data->id_laundry) ?>" class="btn btn-warning <?= ($data->status_pembayaran == 0) ? 'disabled' : ''; ?>" onclick="return confirm('Apakah anda yakin Baju sudah diambil?');">Belum Diambil</i></a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($data->status_pembayaran == 1) { ?>
                                                            ...
                                                            <a href="<?= base_url('Laundry/aksi_cetak_transaksi/' . $data->id_laundry) ?>" class="btn btn-success" target="_blank"><i class="fa fa-download"> Cetak</i></></a>

                                                            <!-- jika status pembayaran = 0 -->
                                                        <?php } elseif ($data->status_pembayaran == 0) { ?>

                                                            <a href="<?= base_url('Laundry/Detail/' . $data->id_laundry) ?>" class="btn btn-primary mb-2"><i class="fa fa-eye"></i> Detail</a>
                                                            <a href="<?= base_url('Laundry/aksi_lunas/' . $data->id_laundry) ?>" class="btn btn-success mb-2" onclick="return confirm('Apakah anda yakin transaksi laundry sudah lunas ?');"><i class="fa fa-money"></i> Lunasi</a>
