                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <h4 class="mt-0 header-title">
                                        <a href="<?= base_url('Pelanggan/tambah') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah data</a>
                                    </h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $data->pelangganalamat ?></td>
                                                    <td><?= $data->pelanggantelp ?></td>
                                                    <td>
                                                        <a href="<?= base_url('Pelanggan/ubah/' . $data->pelangganid) ?>" class="btn btn-warning"><i class="fa fa-tags"></i></a>
                                                        <a href="<?= base_url('Pelanggan/aksi_hapus/' . $data->pelangganid) ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus ?');"><i class="fa fa-trash-o"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
